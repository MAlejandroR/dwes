...
> {{<color>}}Manuel Romero Miguel {{</color>}} 
  {{<color color="text-success">}}manuelromeromiguel  arroba  cpilosenlaces punto com{{</ color>}} {{<color color="text-alert">}}Coordinador del certificado {{</color>}}
{{<color>}}Teléfoono covid{{</color>}}

> {{<color color="text-success">}}649 217 116{{</ color>}} {{<color color="text-alert">}}Teléfono para avisar en caso covid {{</color>}}
> 
